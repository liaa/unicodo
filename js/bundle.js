...
/***/ function(module, exports, __webpack_require__) {
	...
	var list = unicodes.map(function(unicode, index){
	  return React.createElement("li", {key: index, className: "b w-100  pal pvxl pvl-ns mega  tc w-25-ns fl border-box"}, unicode);
	})
	ReactDOM.render(
	  React.createElement("div", null, 
	    ...
	    React.createElement("p", {className: "man"}, React.createElement("a", {href: "https://github.com/liaa/unicodo/issues/new", target: "_blank", className: "link gray"}, "submit →"))
	    ), 

...
/***/ function(module, exports, __webpack_require__) {
	...
	var list = unicodes.map(function(unicode, index){
	  ...
	  return (
	    React.createElement("li", {className: "Unicode b w-100  pal pvxl  w-25-ns fl border-box", key: index}, 
	      React.createElement("div", {className: "dt w-100 tc"}, 
	        React.createElement("div", {className: "dtr mega "}, 
	          React.createElement("div", {className: "dtc"}, 
	            React.createElement("p", {className: "man lh-solid"}, 
	              code
	            )
	          )
	        ), 
	        React.createElement("div", {className: "dtr"}, 
	          React.createElement("div", {className: "thin dtc ptm black-40"}, 
	            React.createElement("p", {className: "man"}, 
	              name
	            )
	          )
	        )
